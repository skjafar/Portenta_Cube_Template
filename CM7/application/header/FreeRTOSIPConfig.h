...
#define ipconfigMAXIMUM_DISCOVER_TX_PERIOD  ( pdMS_TO_TICKS( 40000 ) )
...
#define configECHO_SERVER_ADDR3 158
...
#define ipconfigTCP_RX_BUFFER_LENGTH ( 12 * ipconfigTCP_MSS ) //  ( 3 * 1460 )
#define ipconfigTCP_RX_WIN_SIZE ( 8 )

/* Define the size of Tx buffer for TCP sockets. */
#define ipconfigTCP_TX_BUFFER_LENGTH ( 12 * ipconfigTCP_MSS ) //  ( 2 * 1460 )
#define ipconfigTCP_TX_WIN_SIZE ( 8 )
...
#define configUDP_LOGGING_STRING_LENGTH ( 250 )
...
#define configUDP_LOGGING_TASK_STACK_SIZE   ( 4 * configMINIMAL_STACK_SIZE )
...
/* The IP address to which the UDP messages are sent. NOTE: If these 
 * settings are omitted then the UDP messages will be sent to the local 
 * broadcast address, although broadcast messages can be blocked by switches and routers.
...
#define configUDP_LOGGING_ADDR2 8
...
#define ipconfigIPERF_TX_WINSIZE				( 8 )
