...
/* Interrupt count. */
static uint64_t ulFreeRTOSTimerCount;
...
/* USER CODE BEGIN 1 */
// implement get counter for FreeRTOS task profiling
uint64_t ullGetRunTimeCounterValue( void )
{
    return ulFreeRTOSTimerCount;
}
/* USER CODE END 1 */
